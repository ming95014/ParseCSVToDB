    ...
    public partial class ByExpenses : System.Web.UI.UserControl
    {
        ...
        protected void OnRowDataBound_GridView1(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Cells[9].Text = (row[10].ToString().Trim().Length == 0) ? "N.A." : "<a title='Click to pop-open a new browser to view the receipt' target='_blank' href='" + row[10].ToString() + "'>receipt</a>";
