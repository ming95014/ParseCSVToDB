...
<asp:GridView ID="GridView1" runat="server" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Description" HeaderText="H. Description" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="20%" />
        <asp:BoundField DataField="Receipt" HeaderText="I. Receipt pdf link" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="5%" />
    </Columns>
</asp:GridView>
