...
<asp:GridView ID="GridView1" runat="server" 
                ...
                ShowFooter="true" 
                GridLines="None" CssClass="HeaderStyle"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Position" HeaderText="B. Position" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="10%" SortExpression="Position" />
        <asp:BoundField DataField="Ministry" HeaderText="C. Ministry" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="10%" SortExpression="Ministry"/>
        <asp:BoundField DataField="Category" HeaderText="D. Category " ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="10%" SortExpression="Category"/>
        <asp:BoundField DataField="Type"     HeaderText="E. Type" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="10%" SortExpression="Type"/>
        ...
        <asp:BoundField DataField="Description" HeaderText="H. Description" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="10%" />
        <asp:BoundField DataField="Receipt" HeaderText="I. Receipt pdf link" ItemStyle-HorizontalAlign="Right" HeaderStyle-Width="10%" />
    </Columns>
</asp:GridView>
